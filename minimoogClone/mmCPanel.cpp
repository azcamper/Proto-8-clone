...
//  Knobs
   ...
   // LEDs
	...
	DLed1.setHardware(new Proto8DigitalOut( 49 ), 0);
	DLed2.setHardware(new Proto8DigitalOut( 50 ), 0);
	DLed3.setHardware(new Proto8DigitalOut( 51 ), 0);
	DLed4.setHardware(new Proto8DigitalOut( 52 ), 0);
	DLed5.setHardware(new Proto8DigitalOut( 53 ), 0);
	DLed6.setHardware(new Proto8DigitalOut( 54 ), 0);
	DLed7.setHardware(new Proto8DigitalOut( 55 ), 0);
	DLed8.setHardware(new Proto8DigitalOut( 56 ), 0);
	DLed9.setHardware(new Proto8DigitalOut( 57 ), 0);
	DLed10.setHardware(new Proto8DigitalOut( 58 ), 0);
	DLed11.setHardware(new Proto8DigitalOut( 59 ), 0);
	DLed12.setHardware(new Proto8DigitalOut( 60 ), 0);
	DLed13.setHardware(new Proto8DigitalOut( 61 ), 0);
	DLed14.setHardware(new Proto8DigitalOut( 62 ), 0);
	DLed15.setHardware(new Proto8DigitalOut( 63 ), 0);
	DLed16.setHardware(new Proto8DigitalOut( 64 ), 0);
